...
$temp->setReplace("{pagename}", ' <img src="./image/next.png" border="0" align="absmiddle">ประวัติการพิมพ์แท็ก Tag B');
$temp->setReplace("{content}", $temp->getTemplate("./template/tag_history_tag_b.html"));
