...
$temp = new ReplaceHtml("../template/tag_print_coProduct.html");
$cSql = new SqlSrv();
$lot_tmp = "";
if (!empty($lot)) {
...
if (isset($_POST["tag_ids"])) {
    ...
    for ($t = 0; $t < $s_tag; $t++) {
        $temp->setReplace("{printlist}", $temp->getTemplate("../template/tag_print_block.html"));
        $id = $_POST["tag_ids"][$t];
...
//        $rs2_wc = $cSql->SqlQuery($conn, $sql2_wc);
        ...
        $lot_tmp = (explode("-", $lot_tmp)[0] . "-$num" . sprintf("%'.03d", $pack));
