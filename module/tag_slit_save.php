...
$sql = "insert into Mv_Bc_tag (id, job, suffix, oper_num, item, lot, qty1, uf_act_Weight, uf_pack, mfg_date, print_date, ship_stat, active, uf_sts_job, uf_grade, Uf_manu, uf_spec, um1, um2, sts_no) values ('".$id."', '".$jobm[0]."', '".$jobm[1]."', '".$jobm[2]."', '".$item."', '".$slot[0].$lot."', '".$uf_act_Weight."', '".$uf_act_Weight."', '".$pack_no."', '".$print_day."', '".$print_day."', '0', '1', '".$uf_sts_job."', 'A', '".$slot[1]."', '".$slot[2]."', '".$um1."', '".$um2."', '".$sts_no."');";
//echo $sql." =======================";
