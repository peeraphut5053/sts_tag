...
if ($m_id == "m1") {
	...
	$menu .= blockmenu("พิมพ์แท็กท่อ (co-product)", $bgcl[7], "scan_jobOrder_start&linkcmd=tag_history_forming_coProduct");	
	...
	$menu .= blockmenu("พิมพ์ Barcode MiscReceipt", $bgcl[16], "print_lot_barcode");
